...
class kpiADYCN extends conexion {
    ...
    public function listaKPI(){
        ...
        $KpiResult = [
            ...
            "kpi" =>    [
                            [
                                "id" => 1,
                                "nombre" => "Porcentaje de disponibilidad de los Sistemas Contra Incendio ",
                                "tipo" => "charLine",
                                "datos" => [
                                            "labels"=>  ['Sistemas de Extinción', 'Sistema de Detección', 'Vehículos de Emergencia'],
                                            "dataset"=> [
                                                [
                                                "label"=> 'AMC',
                                                "data"=> [65, 59, 90],          
