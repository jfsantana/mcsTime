...
$_POST['header']['creadoPor'] = $_SESSION['usuario'];




$URL = "http://" . $_SERVER['HTTP_HOST'] . "/funciones/wsdl/evaluacionSimulacion";
...
$rs = API::JSON_TO_ARRAY($rs);
 ...
 if (@$rs['status'] == 'OK') {
    $url = "onclick=\"location.href='../../dashboard.php?activo=mola';\"";
} else {
