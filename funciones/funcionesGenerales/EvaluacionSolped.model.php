 ...
 ***************************************************/
$solpedGetID = $_POST['header']['banfn'];
$codArea = $_POST['header']['codArea'];
...
$parametrosIN['regPrecios'] = @$_POST['regPrecios'];
...
<?php
    ...
    if (@$rsWeb['status'] == 'OK') {
        ...
        switch ($codArea) {
            case '000':
                $url = "onclick=\"location.href='../PHPMailer-master/enviarcorreoNotificacionEstimacion.php?solped=$solpedGetID';\"";
                break;
            default:
