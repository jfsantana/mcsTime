...
//print("<pre>".print_r(($_POST['header']),true)."</pre>"); die;
// En este caso la Vista respeto la estructura
//falta agregar ña fecha añ formulario


$token = $_SESSION['token'];
//print("<pre>".print_r(json_encode($_POST),true)."</pre>"); die;
$URL	= "http://" . $_SERVER['HTTP_HOST'] . "/funciones/wsdl/indicadorSP";
...
//print("<pre>".print_r(($rs['status']),true)."</pre>"); die;
