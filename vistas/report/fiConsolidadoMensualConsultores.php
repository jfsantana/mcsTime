...
$URL        = "http://" . $_SERVER['HTTP_HOST'] . "/funciones/wsdl/empleados?idProyecto=" . @$_POST['proyecto'] . "&idConsultora=" . @$_POST['consultora'] . "&mes=" . $mesAux;
$rs         = API::GET($URL, $token);
                  ...
                  <tbody>
                    ...
                    ?>
                      ...
                      <tr>
                        ...
                        <td><button type="button" class="btn btn-default" data-toggle="modal" data-target="#modal-xl"><?php echo $ResumenConsultore['Consultor']; ?> </button></a></td>
...
AQUI TENGO QUE LLAMAR AL SERVICIO CON LOS DATOS -->
            <?php
            $URLaux        = "http://" . $_SERVER['HTTP_HOST'] . "/funciones/wsdl/empleados?id_empleado=" . @$ResumenConsultore['id_usu'] . "&idEmpresaConsultora=" . @$_POST['consultora'] . "&idProyecto=" . @$_POST['proyecto'] . "&mes=" . @$_POST['mes'];
            ...
            <table id="tablaModal" class="table table-bordered table-striped">
              ...
              <tbody>
                <?php
                $totalTotal = 0;
                foreach ($arrayResumenConsultoresDetalle as $ResumenConsultore) { //
                ?>

                  <tr>

                    <td><?php echo $ResumenConsultore['ape_usu'].', '.$ResumenConsultore['nom_usu']; ?></td>
                    <td><?php echo $ResumenConsultore['ced_usu']; ?></td>
                    <td><?php echo $ResumenConsultore['nombreEmpresaConsultora']; ?></td>
                    <td><?php echo $ResumenConsultore['NombreCliente']; ?></td>
                    <td><?php echo $ResumenConsultore['nameProyecto']; ?></td>
                    <td><?php echo $ResumenConsultore['tipoAtencion']; ?></td>
